...
public class FooterController {
	...
	public String danhSachPhongTro(@PathVariable String typeroom, @PathVariable String city,
			@RequestParam(required = false) String district, @RequestParam(required = false) Integer district_id,
			@RequestParam(defaultValue = "mac-dinh") String orderby, @RequestParam(defaultValue = "1") int page,
		...
		if (city.equals("Toàn quốc")) {
			...
			if (district_id != null) {
				listing = listingsService.getListingsByDistrictAndOrder(roomtype_id, city_id, district_id, orderby,
